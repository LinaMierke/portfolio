        ...
        <Grid container spacing={1}>
          <Grid container item xs={12} spacing={3}>
            <Card className={classes.root}>
              ...
              <a href="https://github.com/LinaMierke/api_project" target="_blank" rel="noopener noreferrer">
                <IconButton aria-label="add to favorites">
                  <GitHubIcon />
                </IconButton>
                </a>
                <a href=" https://linacountries.herokuapp.com/" target="_blank" rel="noopener noreferrer">
